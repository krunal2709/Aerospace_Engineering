function current = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   CURRENT = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   CURRENT = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   current = importfile1('current.txt', 1, 434);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/06/18 02:43:56
...
current = table;
current.Week903almanacforPRN01 = rawCellColumns(:, 1);
current.VarName2 = cell2mat(rawNumericColumns(:, 1));
